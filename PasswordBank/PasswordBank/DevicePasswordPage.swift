...
class DevicePasswordPage: UIViewController {
    ...
    var color2 = UIColor()
     ...
     var timer = Timer()
       ...
       override func viewDidLoad() {
        ...
        Password.text = decrypt(userDevicePasswords[username]![passIdentifier]!, decryption1(ciphers[username]!))
        fitText()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        mainController.userDevicePasswords = self.userDevicePasswords
        ...
        mainController.devicePasswordChanged = self.devicePasswordChanged
        mainController.page = "devices"
        }
    }
    ...
    func fitText()
    {
        ...
        if userDevicePasswords[username]![passIdentifier]!.count <= 5
        {
            Password.font = UIFont.systemFont(ofSize: 45)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 10 && userDevicePasswords[username]![passIdentifier]!.count > 5
        {
            Password.font = UIFont.systemFont(ofSize: 40)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 15 && userDevicePasswords[username]![passIdentifier]!.count > 10
        {
            Password.font = UIFont.systemFont(ofSize: 35)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 20 && userDevicePasswords[username]![passIdentifier]!.count > 15
        {
            Password.font = UIFont.systemFont(ofSize: 30)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 25 && userDevicePasswords[username]![passIdentifier]!.count > 20
        {
            Password.font = UIFont.systemFont(ofSize: 27)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 30 && userDevicePasswords[username]![passIdentifier]!.count > 25
        {
            Password.font = UIFont.systemFont(ofSize: 24)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 35 && userDevicePasswords[username]![passIdentifier]!.count > 30
        {
            Password.font = UIFont.systemFont(ofSize: 21)
        }
        if userDevicePasswords[username]![passIdentifier]!.count <= 40 && userDevicePasswords[username]![passIdentifier]!.count > 35
        {
        ...
        @IBAction func DeletePassword(_ sender: UIButton) {
            ...
            userDevicePasswords[username]!.removeValue(forKey: passIdentifier)
            devicePasswordChanged = true
            home = true
            performSegue(withIdentifier: "DevicePassToMain", sender: self)
        }
    ...
    //        UIView.animate(withDuration: 1, animations: {self.ChangePassView.frame.origin.x += 50})
        ...
        @IBAction func Submit(_ sender: UIButton) {
            resetTimer()
            userDevicePasswords[username]![passIdentifier]! = encrypt(NewPassword.text!, decryption1(ciphers[username]!))
            Password.text = decrypt(userDevicePasswords[username]![passIdentifier]!, decryption1(ciphers[username]!))
            devicePasswordChanged = true
            UIView.animate(withDuration: 0.6, animations: {self.ChangePassView.transform = CGAffineTransform(scaleX: 0.01, y: 0.01); self.ChangePassView.alpha = 0}, completion: {finished in self.ChangePassView.isHidden = true})
        }
    ...
    @IBAction func SignOut(_ sender: UIButton) {
        ...
        performSegue(withIdentifier: "ViewDeviceToStart", sender: self)
    }
